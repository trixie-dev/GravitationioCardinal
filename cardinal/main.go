...
import (
	...
	"GravitationioShard/query"
	"GravitationioShard/system"
)
...
func MustInitWorld(w *cardinal.World) {
	...
	Must(
		...
		cardinal.RegisterComponent[component.Balance](w),
	)
	...
	Must(
		...
		cardinal.RegisterQuery[query.PlayerGetBalanceRequest, query.PlayerGetBalanceResponse](w, "player-get-balance", query.PlayerGetBalance),
	)
